...
### 3.1 Script data from [top 40 companies in Singapore by market capitalisation](https://companiesmarketcap.com/singapore/largest-companies-in-singapore-by-market-cap/)
...
ori <- sum(range(cutpoints$close))/2
sca <- seq(range(cutpoints$close)[1], 
           range(cutpoints$close)[2], 
           length.out = 7)[-4]
...
adjust the size of plot, set the x-axis interval to 3 months. 
consider use par() in base R to resize the plot
